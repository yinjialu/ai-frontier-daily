...
resource: https://www.anthropic.com/research/global-workspace
published: 2026-07-06
tags: [语言模型可解释性, 全局工作空间, 内部推理, 神经科学启示]
detected: 2026-07-07T03:58:07+08:00
---

Anthropic发现Claude内部存在一个称为J-space的神经模式集合，类似于全局工作空间，具有可报告、可调节、用于内部推理等特性，可用于监控模型隐藏思维和意图。
