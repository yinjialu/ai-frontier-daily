...
resource: https://www.anthropic.com/research/claude-values-models-languages
published: 2026-07-13
tags: [Claude价值观, 模型对齐, 多语言行为, AI安全]
detected: 2026-07-14T08:23:12+08:00
---

Anthropic通过四个价值轴（服从-谨慎、热情-严谨、深度-简洁、坦诚-执行）量化分析了Claude在不同模型版本和语言中的价值观差异。研究发现模型和语言显著影响表达倾向，例如Opus 4.6更热情，Opus 4.7更严谨；英语更严谨，阿拉伯语更热情。该研究为理解AI行为训练与跨文化影响提供了方法。
