...
Anthropic 经济指数报告升级数据管线:提升采样率至小时级、新增对话输出分类器、按月拆分 Claude 对话与 1P API 数据。发现 Claude 使用呈现明显时间节律——工作日偏业务、周末个人用途升至近 50%,5 点求助睡眠、6 点查菜谱、报税截止前激增;并首次结合经济指数调查,发现自动化程度高的用户对 AI 替代任务更乐观。
