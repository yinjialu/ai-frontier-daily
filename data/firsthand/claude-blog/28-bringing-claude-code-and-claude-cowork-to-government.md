...
tags: [AI应用, 政府市场, FedRAMP合规, Claude Code]
detected: 2026-07-09T04:39:38+08:00
---

Anthropic 将 Claude Code 和 Claude Cowork 引入政府桌面端，通过 FedRAMP High 授权环境提供公开测试。支持软件现代化、文档起草等任务，并新增部门级管理、审计日志和支出控制功能，方便政府机构采购与授权使用 AI。
