...
tags: [AI原生SDLC, Claude Code, Agentic AI, 软件开发流程]
detected: 2026-08-23T17:00:52+08:00
---

Anthropic提出AI原生SDLC指南，指出代码编写已不再是瓶颈，传统软件开发生命周期需围绕Agentic AI重构。通过在计划、设计、构建、测试、部署、维护各阶段嵌入AI，解决构建加速后周围阶段的人速瓶颈、控制失效与治理成本问题。
...
intent.md
for Stage 1: Plan, at which point the loop starts feeding itself.
