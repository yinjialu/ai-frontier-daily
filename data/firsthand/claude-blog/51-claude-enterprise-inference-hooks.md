...
source: claude-blog
resource: https://claude.com/blog/claude-enterprise-inference-hooks
published: 2026-08-05
tags: [Claude Enterprise, 数据防泄漏, AI安全, 企业级AI]
detected: 2026-08-06T21:35:42+08:00
---

Claude Enterprise推出Inference hooks，通过WebSocket将每次推理请求路由至企业DLP服务器，在模型生成前及工具调用返回时实时执行允许/拒绝策略，覆盖Chat、Claude Code、Cowork等全部企业面，支持shadow mode与灰度发布，已开放beta。
...
Getting started
Inference hooks is available today in beta for Claude Enterprise customers. Read the
documentation
to configure your organization's DLP server and start enforcing policy across Claude Enterprise surfaces.
