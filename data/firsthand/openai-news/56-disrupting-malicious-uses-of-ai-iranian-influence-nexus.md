...
source: openai-news
resource: https://openai.com/index/disrupting-malicious-uses-of-ai-iranian-influence-nexus
published: 2025-02-01
tags: [伊朗影响力行动, AI滥用, OpenAI安全, 虚假信息]
detected: 2026-08-02T17:00:22+08:00
---

OpenAI封禁了5个与伊朗影响力行动相关的ChatGPT账号，这些账号利用AI生成文章和推文，服务于IUVM和STORM-2035两个行动，并发现两者间存在潜在关联。内容以亲巴勒斯坦、亲伊朗为主，但影响力有限，评估为低端Category 2。

## Full Text

Iranian influence nexus: Cross-platform activity | OpenAI
...
report.
Actor
We banned five ChatGPT accounts that generated a small number of tweets and articles that were then posted on third party assets publicly linked to known Iranian influence operations. One of these operations is known as the
International Union of Virtual Media, or IUVM
⁠
(opens in a new window)
;
Microsoft reported
⁠
(opens in a new window)
the other as STORM-2035. We disrupted and reported earlier activity by these two operations last year.
...
STORM-2035 is a wide-ranging operation, with websites reported by the open-source community in Arabic, French, and Spanish, as well as English. A fourth ChatGPT account used our models to generate a small number of Spanish-language articles for another website identified by
public research
⁠
(opens in a new window)
, lalinearoja[.]net.
...
First, the same account also generated English-language articles that were published on another website, iuvmpress[.]co. This website is linked to IUVM, which
Reuters first exposed in 2018
⁠
(opens in a new window)
. To the best of our knowledge, public reporting had not yet identified overlaps between critiquepolitique[.]com and iuvmpress[.]co.
...
⁠
(opens in a new window)
to assess the impact of IO, which rates them on a scale of 1 (lowest) to 6 (highest), we would assess this as being at the low end of Category 2 (activity on multiple platforms, but no evidence that real people picked up or widely shared their content).
Author
OpenAI
Research
Research Index
